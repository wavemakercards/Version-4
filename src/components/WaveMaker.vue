...
export default {
  ...
  methods:{
    ProjectClose(){
        console.warn("Closing the project warning needed")
    },
    ProjectUpload(){

     console.log('%c Not yet you will need to clear the local database  in the f12 applications tab', 'color: pink;font-size:2rem;')
    }
  }
};
</script>
